...
sanitización y controles C03/C04/C05/C06 son `IMPLEMENTED_UNVALIDATED`; no deciden el
...
taskCompleted no asignan ni resuelven trabajo. C06 añade mapeo exacto de errores,
validación cerrada por Relay, reconciliación por el mismo `providerRef` y revisión
humana obligatoria sin habilitar red. La ausencia de `resultValidation` en Calls
