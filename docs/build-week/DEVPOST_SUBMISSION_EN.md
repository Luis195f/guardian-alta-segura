...
The C09 dependency audit also reports inherited advisories (2 critical, 9 high
and 3 moderate) in the unchanged lockfile. They block any claim that this build
is ready for public deployment and require a separately scoped upgrade and full
revalidation.
