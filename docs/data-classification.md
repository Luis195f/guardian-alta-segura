...
| Autenticación | Identidad de cuenta, rol, sesión, invitaciones y tokens, perfil seudonimizado de cuidador y metadatos del proveedor | Solo componentes de identidad y administración autorizada; secretos nunca visibles al cliente o soporte | Resultado, timestamp, correlation ID y código sanitizado; nunca token, secreto o credencial | Proveedor institucional pendiente, mínimo privilegio, hashes persistidos, invitaciones de un uso, sesiones revocables y secretos fuera de logs. |
