...
| GAS2-R-005 | Clinical safety/process | `BLOCKED_BY_DECISION` | No approved task SLA, priority, assignment or escalation | Omission/timing cannot be institutionally interpreted | Partial Process Safety only; real pilot blocked if in scope | DEC-017 |
