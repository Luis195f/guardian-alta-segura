...
| GAS2-R-015 | Integration | `DEFERRED` | No external/FHIR adapter or contract; ADR-0018 is documentary and read-only | No real interoperability | Does not block local demo; blocks integration claims | DEC-018 plus approved contract/profile first |
