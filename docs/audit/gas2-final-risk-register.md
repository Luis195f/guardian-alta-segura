...
| GAS2-R-021 | External sandbox / privacy / safety | `BLOCKED_BY_DECISION` | [ADR-0019](../adr/0019-calle-hackathon-sandbox-boundary.md), C00 estático divergente, adapter REST C02 `IMPLEMENTED_DISABLED`, HAZ-GAS-021–038 y GAP-DCB-025 | Controles técnicos fake `IMPLEMENTED_UNVALIDATED`; sin SDK, entrypoint ni llamadas; cancelación ausente, brecha POST/persistencia, intentos físicos múltiples posibles, autoridad/voz/retención/términos aún pendientes | Sandbox REST disabled; demo pública LIVE OFF; ensayo live condicionado y datos reales/piloto/producción NO_GO | DEC-019 y dependencias: revisión humana, licencia SDK separada, términos/garantías REST, gates y pruebas live futuras; sin aceptación residual |
