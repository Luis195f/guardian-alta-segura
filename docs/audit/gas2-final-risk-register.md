...
| GAS2-R-021 | External sandbox / privacy / safety | `BLOCKED_BY_DECISION` | [ADR-0019](../adr/0019-calle-hackathon-sandbox-boundary.md), C00 estático divergente, adapter REST C02 `IMPLEMENTED_DISABLED`, core interno C03, Patient Relay local sintético C04, HAZ-GAS-021–038 y GAP-DCB-025 | Controles técnicos C02/C03/C04 `IMPLEMENTED_UNVALIDATED`; sin SDK, resolver real, policy/attestation productivas, entrypoint live ni llamadas; cancelación ausente, brecha POST/persistencia, intentos físicos, autoridad institucional, voz, retención y términos pendientes | Patient Relay C04 solo local/sintético; Professional Relay ausente; sandbox REST disabled; demo pública LIVE OFF; datos reales/piloto/producción NO_GO | DEC-019 y dependencias: fuente canónica real de destino/attestation, revisión humana, licencia SDK separada, términos/garantías REST, gates y pruebas live futuras; sin aceptación residual |
