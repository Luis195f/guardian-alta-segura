...
| “The operational continuity panel is a bounded, read-only administrative projection” | Architecture/demo UI | P10 cursor, PostgreSQL and E2E tests | `SUPPORTED_TECHNICAL_CLAIM` | Qualify as synthetic; current responsibility requires active eligible roles; governance is an unexecuted on-demand reference; freshness is unknown; 5B remains unexposed; and the panel is not a risk or clinical-priority dashboard |
