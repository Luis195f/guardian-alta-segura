...
## C01/C02/C03/C04 — alcance de los claims CALL-E

CLAIM-GAS2-038, CLAIM-GAS2-039 y CLAIM-GAS2-040 solo permiten los textos acotados de ADR-0019. El SHA de cada fila
identifica la base anclada de su revisión. C02 está incorporado en la base C03;
la publicación de C03 como Draft PR aporta revisión técnica, no evidencia clínica
