...
| CLAIM-GAS2-038 | “Se ha implementado un adapter REST server-only y desactivado para una futura evaluación CALL-E exclusivamente sintética. No existe entrypoint live, no se incorporó el SDK y no se ejecutaron llamadas. No autoriza uso clínico, piloto ni producción.” | Architecture / synthetic hackathon only | ADR-0019; port neutral, adapter REST, HMAC, persistencia técnica y pruebas con transporte falso; runtime desactivado y sin entrypoint | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-022-B / HAZ-GAS-022; CTRL-029-B / HAZ-GAS-029; CTRL-037-B / HAZ-GAS-037 | `src/application/outbound-call/execute-outbound-call.test.ts`; `src/infrastructure/call-transport/call-e-rest-adapter.test.ts`; `src/infrastructure/persistence/outbound-call-intent.integration.test.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `8a539159427e1bf57f0c66092ecbd2d3ba0400f1` | Claim limitado al delta C02 incorporado mediante squash en la base C03; `IMPLEMENTED_UNVALIDATED`, sin live, validación clínica o aceptación residual |
| CLAIM-GAS2-039 | “C03 implementa un core interno desactivado con dos parejas tipo/finalidad, preview sin red, confirmación one-use, revalidación y lifecycle auditable; usa autoridad y policy exclusivamente sintéticas en pruebas. El aviso de no cancelación está presente solo en el contrato sintético de preview, sin UI. No existe resolver real, entrypoint, Patient/Professional Relay completo ni llamada.” | Architecture / synthetic hackathon only | ADR-0019; port de autoridad fail-closed; binding HMAC, digest de token, CAS PostgreSQL, RelayAttempt/Event y composición posterior con C02 | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-028-B / HAZ-GAS-028; CTRL-029-B / HAZ-GAS-029; CTRL-030-B / HAZ-GAS-030; CTRL-032-B / HAZ-GAS-032 | `src/application/relay/manage-continuity-relay.test.ts`; `src/infrastructure/persistence/continuity-relay.integration.test.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `893cb8b0b555d59128369d965d3b908d942ae414` | Claim limitado al delta C03 sobre la base anclada; la publicación como Draft PR no aporta validación clínica o institucional; `IMPLEMENTED_UNVALIDATED`, resolver/attestation/policy productivos ausentes, sin relays completos, live o aceptación residual |
| CLAIM-GAS2-040 | “C04 implementa un recorrido Patient Relay local, determinista y completamente sintético: acción profesional explícita, preview visible sin red, confirmación one-use, executor local que devuelve un fixture técnico predeterminado, resultado cerrado y revisión humana. El teléfono completo no se expone ni persiste; no existe llamada, conversación, modelo, proveedor, entrypoint live, decisión automática ni resolución de Task.” | Architecture / synthetic hackathon only | ADR-0019; resolver demo server-side restringido al fixture sintético; task contract estático/schema cerrado; cookie HttpOnly; executor sin proveedor; UI/API y lifecycle C03 | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-021-B / HAZ-GAS-021; CTRL-028-B / HAZ-GAS-028; CTRL-029-B / HAZ-GAS-029; CTRL-030-B / HAZ-GAS-030; CTRL-031-B / HAZ-GAS-031; CTRL-032-B / HAZ-GAS-032; CTRL-033-B / HAZ-GAS-033; CTRL-034-B / HAZ-GAS-034; CTRL-035-B / HAZ-GAS-035; CTRL-037-B / HAZ-GAS-037 | `src/domain/relay/patient-relay-contract.test.ts`; `src/infrastructure/http/patient-relay-confirmation-cookie.test.ts`; `src/application/relay/manage-continuity-relay.test.ts`; `src/infrastructure/persistence/continuity-relay.integration.test.ts`; `tests/e2e/patient-relay.spec.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `7614195020733a5c7fab4ec3c9a85b7b4df7cf31` | Claim limitado al delta C04 y a su publicación técnica como Draft PR; `IMPLEMENTED_UNVALIDATED`; voz/proveedor y contención real `NOT_TESTED`; autoridad/policy productivas ausentes; no demuestra validación clínica, institucional, regulatoria, de proveedor ni aceptación residual |
| CLAIM-GAS2-041 | “C05 implementa Professional Relay como segundo carril separado, local y completamente sintético: el servidor deriva una única Task opaca y profesional elegible, revalida episodio/asignación/scope/RoleAssignment antes de consumir y ejecutar, aplica un fixture cerrado y deja el resultado pendiente de revisión humana. No existe target arbitrario, red, llamada, conversación, voz, proveedor, autoasignación ni resolución automática.” | Architecture / synthetic hackathon only | ADR-0019; autoridad demo derivada server-side; contrato/schema cerrado; CAS con guardas relacionales; cookie HttpOnly separada; executor local; UI/API y lifecycle C03 | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-028-B / HAZ-GAS-028; CTRL-029-B / HAZ-GAS-029; CTRL-030-B / HAZ-GAS-030; CTRL-032-B / HAZ-GAS-032; CTRL-034-B / HAZ-GAS-034; CTRL-037-B / HAZ-GAS-037 | `src/domain/relay/professional-relay-contract.test.ts`; `src/infrastructure/http/professional-relay-confirmation-cookie.test.ts`; `src/application/relay/manage-continuity-relay.test.ts`; `src/infrastructure/persistence/continuity-relay.integration.test.ts`; `tests/e2e/professional-relay.spec.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `834ddecd7edbfc21bf20c50a3d641f627ab221dc` | Claim limitado al delta C05 y a revisión humana; `IMPLEMENTED_UNVALIDATED`; acknowledged/availability/taskCompleted no aceptan, asignan ni resuelven Task; voz/proveedor/divulgación live `NOT_TESTED`; autoridad/policy productivas ausentes; no demuestra validación clínica, institucional, regulatoria ni aceptación residual |
| CLAIM-GAS2-042 | “C06 implementa una frontera local fail-closed para normalizar errores CALL-E demostrados, validar por separado los resultados Patient/Professional, reconciliar por el mismo providerRef sin recrear y mantener todo terminal pendiente de revisión humana. No persiste contenido crudo ni modifica automáticamente una Task.” | Architecture / synthetic hackathon only | ADR-0019; mapper exacto; schemas cerrados; ledger Relay/OutboundCall existente; CAS PostgreSQL y tests con transporte falso | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-022-B / HAZ-GAS-022; CTRL-026-B / HAZ-GAS-026; CTRL-029-B / HAZ-GAS-029; CTRL-030-B / HAZ-GAS-030; CTRL-031-B / HAZ-GAS-031; CTRL-037-B / HAZ-GAS-037 | `src/application/relay/result-governance.test.ts`; `src/application/outbound-call/execute-outbound-call.test.ts`; `src/infrastructure/call-transport/call-e-rest-adapter.test.ts`; `src/infrastructure/persistence/continuity-relay.integration.test.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `6a56391dfc7588b2669ff7a584a2a0852331bfb7` | Claim limitado al delta C06 sobre la base exacta y a pruebas sintéticas/locales; `IMPLEMENTED_UNVALIDATED`; Calls 0.6.0 no expone resultValidation; proveedor/voz/live `NOT_TESTED`; no demuestra eficacia, conformidad, aprobación institucional ni aceptación residual |
| CLAIM-GAS2-043 | “C07 aporta pruebas adversariales locales reproducibles de las invariantes C02–C06: autorización y revalidación, cardinalidad singular, carreras/replay sin segundo create, schemas cerrados, contención minimizada y axe focalizado. Patient Relay revalida el RoleAssignment vigente. No se ejecutan llamadas ni red CALL-E.” | Architecture / synthetic hackathon only | ADR-0019; tests unitarios, PostgreSQL, tooling y E2E con fakes/fixtures sintéticos; checker de ausencia de ingress/webhook | `IMPLEMENTED_AND_TESTED` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-021-B / HAZ-GAS-021; CTRL-022-B / HAZ-GAS-022; CTRL-028-B / HAZ-GAS-028; CTRL-029-B / HAZ-GAS-029; CTRL-030-B / HAZ-GAS-030; CTRL-031-B / HAZ-GAS-031; CTRL-037-B / HAZ-GAS-037 | `src/domain/relay/continuity-relay-adversarial.test.ts`; `src/application/relay/manage-continuity-relay.test.ts`; `src/application/outbound-call/execute-outbound-call.test.ts`; `src/infrastructure/persistence/continuity-relay.integration.test.ts`; `tests/e2e/zz-continuity-relay-adversarial.spec.ts`; `scripts/check-calle-rest-boundary.test.mjs` | `3c476c70a8700e4adab3a33aaff5f28aa6c96469` | Claim limitado a contrato/parser/policy local y recorridos sintéticos C07; no hay modelo institucional de unidad, proveedor, voz, conversación, red live, validación clínica/regulatoria/WCAG general ni aceptación residual |
| CLAIM-GAS2-044 | “C08 revalidó fuentes oficiales y aplicó los gates live de forma fail-closed: no había `CALLE_API_KEY` en la sesión ni destino propio/autorizado atestado por mecanismo local seguro, por lo que no hubo GET autenticado, dry-run, entrypoint o llamada. ES/+34 e inglés/español con Line Region International es solo capacidad regional publicada para pruebas, no autorización ni prueba runtime.” | Architecture / controlled-live evidence only | ADR-0019 y evidence index C08; consulta oficial fechada y comprobación local limitada a presencia/ausencia de variable | `DOCUMENTED_ONLY` | REQ-02, REQ-06, REQ-09, REQ-12, REQ-13 | DEC-003, DEC-005, DEC-013, DEC-014, DEC-015, DEC-016, DEC-017, DEC-019 | CTRL-027-B / HAZ-GAS-027; CTRL-028-B / HAZ-GAS-028; CTRL-029-B / HAZ-GAS-029; CTRL-037-B / HAZ-GAS-037 | `NOT_APPLICABLE` | `219fe413afbff6947ad863967a3697a249ad1b6a` | Claim documental del bloqueo C08; cuenta/capacidad/KYC/presupuesto/destino/live no verificados, SDK ausente y licencia sin resolver; DEC-019, GAP-DCB-025, GAS2-R-021 y hazards permanecen abiertos sin aceptación residual |

## C01/C02/C03/C04/C05/C06/C07/C08 — alcance de los claims CALL-E

CLAIM-GAS2-038 a CLAIM-GAS2-044 solo permiten los textos acotados de ADR-0019. El SHA de cada fila
identifica la base anclada de su revisión. C02 está incorporado en la base C03;
la publicación de C05 como Draft PR aporta revisión técnica, no evidencia clínica
ni live. La verificación del checker comprueba referencias/taxonomía y las suites
prueban fakes, bloqueo de red, confirmación concurrente, resultado cerrado y persistencia sintética; ninguna demuestra una
...
| Patient Relay | Yes | “Local deterministic synthetic workflow pending human review” | No provider contact, clinical approval, real authority or Task resolution | C04 unit/integration/E2E |
| Professional Relay | Yes | “Server-derived local synthetic workflow pending human review” | Predetermined fixture only; no arbitrary target, provider contact, assignment, Task resolution or live evidence | C05 unit/integration/E2E |
| Relay result governance | Yes | “Local exact mapping, strict validation and same-reference reconciliation tested with fakes” | No provider/live evidence; every terminal remains pending human review; Calls 0.6.0 has no `resultValidation` field | C06 unit/integration/boundary tests |
