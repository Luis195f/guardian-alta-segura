...
| GAP-DCB-025 | Dependencia externa futura del sandbox CALL-E | Contrato divergente, términos, idempotencia, intentos físicos, contención de voz, minimización y gates de llamada sin resolver ni probar | [ADR-0019](../../adr/0019-calle-hackathon-sandbox-boundary.md), síntesis C00 estática y HAZ-GAS-021–038; sin integración ni llamadas; demo pública LIVE OFF | Resolver DEC-019, aclaraciones del proveedor y licencia/términos antes de publicar C02; verificar gates, fallos y privacidad en fase separada autorizada; mantener uso clínico/piloto/producción NO_GO | Responsable del proyecto y revisores técnicos/jurídicos por designar para sandbox; CSO y autoridades clínicas/institucionales futuros para cualquier uso real | `OPEN`; ninguna verificación live, validación clínica, transferencia o aceptación residual |
