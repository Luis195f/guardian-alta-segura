...
| Controles actuales | Sin runtime/llamadas CALL-E. `CTRL-034-A`: contrato/UI/E2E C04 mantienen el límite ante petición clínica o farmacológica y ofrecen contacto humano sin contestar contenido (`IMPLEMENTED_UNVALIDATED`). |
...
| Evidencia | ADR-0019, sección «Peticiones fuera de alcance y emergencia», y evidencia común C01 anterior; C00 `DIVERGENT / LIVE NOT_RUN`. |
| Prueba / estado | Unit y E2E C04 prueban consejo clínico/farmacológico cero en el recorrido sintético; `OPEN / IMPLEMENTED_UNVALIDATED / CSO_REVIEW_REQUIRED`; comportamiento live no validado; aceptación `NOT_DEMONSTRATED`. |
...
| HAZ-GAS-028 | C028-A | CTRL-028-A/B | ADR-0019; C03/C04 evidence index | Overrides cliente rechazados, revalidación y disclosure cero probados; resolver real deny-all | REQ-02/06/09/12/13; ADR-0017/0019; DEC-019 | Autoridades propuestas en la entrada, pendientes | `OPEN / IMPLEMENTED_UNVALIDATED` |
...
| HAZ-GAS-033 | C033-A | CTRL-033-A/B | ADR-0019; C04 evidence index | Contrato determinista conserva finalidad/schema ante injection; voz live no probada | REQ-02/06/09/12/13; ADR-0017/0019; DEC-019 | Autoridades propuestas en la entrada, pendientes | `OPEN / IMPLEMENTED_UNVALIDATED` |
| HAZ-GAS-034 | C034-A | CTRL-034-A/B | ADR-0019; C04 evidence index | Límite clínico/farmacológico sintético probado; comportamiento live no probado | REQ-02/06/09/12/13; ADR-0017/0019; DEC-019 | Autoridades propuestas en la entrada, pendientes | `OPEN / IMPLEMENTED_UNVALIDATED` |
